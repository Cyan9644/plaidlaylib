                        ...
                        const std::string& pat)
{
    ...
    chunk_seq matches = ChunkSequenceOps::ChunkRabinKarp<char>(text, out_prefix, pat);
...
int main(int argc, char* argv[]) {
    ...
    all_pass &= run_rk_test("random_abab",
