...
static std::vector<uint64_t> reference_kmp(size_t n,
...
int main(int argc, char* argv[]) {
  ...
  all_pass &=
      run_kmp_test("random_abab", 3 * CHARS_PER_CHUNK + 7, random4, "abab");
