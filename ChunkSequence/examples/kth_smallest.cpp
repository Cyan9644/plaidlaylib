// Example: out-of-core kth-smallest selection via plaid::kth_smallest.
//
...
// randomized-pivot algorithm in chunk_kth_smallest.h (oversampled pivots ->
// bucket via heap_tree -> histogram_by_index -> pack the winning bucket ->
// recurse), which mirrors parlaylib's in-memory kth_smallest but keeps every
// intermediate out of core.
//
...
// kth_smallest (deps/parlaylib-examples/kth_smallest.h) on the same keys as a
// DRAM baseline and cross-checks the selected value (the result is a single
...
#include "parlaylib-examples/kth_smallest.h"
