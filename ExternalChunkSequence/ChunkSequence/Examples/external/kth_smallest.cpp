// Example: out-of-core kth-smallest selection via ChunkSequenceOps::kth_smallest.
//
...
// then selects the k-th smallest key with the out-of-core randomized-pivot
// algorithm in Examples/external/ExternalKthSmallest.h (oversampled pivots ->
