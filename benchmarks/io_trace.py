...
def plot_trace(ser, markers, devices, t0, path):
    ...
    ax_bw.plot(xs, ser["agg_read"], "-", color=plot_style.PALETTE["blue"], label="read", linewidth=0.7)
    ax_bw.plot(xs, ser["agg_write"], "-", color=plot_style.PALETTE["red"], label="write", linewidth=0.7)
    ...
    ax_bn.plot(xs, ser["mean_util"], "-", color=plot_style.PALETTE["violet"], label="mean drive %util", linewidth=0.7)
    ax_bn.plot(xs, ser["cpu"], "-", color=plot_style.PALETTE["green"], label="CPU %", linewidth=0.7)
    ax_bn.plot(xs, ser["iowait"], "-", color=plot_style.PALETTE["orange"], label="iowait %", linewidth=0.7)
